...
// const temperatureInFahrenheit = (degreeCelsius) =>
//   console.log(`It is currently ${toFahrenheit(degreeCelsius)}ºF at Mars`);

// const greet = (degreeCelsius) =>
//   console.log(`Hi there! Curiosity here. Right now is ${degreeCelsius}ºC at Mars`);
...
//   const sendMarsTemperature = (callbackTemp, callbackError) => {
//     setTimeout(() => {
//         if ( Math.random() <= 0.6) {
//             return callbackTemp(getMarsTemperature());
//         } else {
