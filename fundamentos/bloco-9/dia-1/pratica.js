...
//     // console.log(userToReturn.firstName);
...
// delay(getUser(userNationality)); // deve imprimir "Ivan is Russian" depois de um certo tempo
...
// const getCountry = (callbackCountry, callbackError) => {
//   setTimeout(() => {
